...
""));
        ...
        pushButton_5->setGeometry(QRect(20, 110, 81, 31));
        pushButton_5->setFont(font);
        pushButton_5->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
        pushButton_6 = new QPushButton(File);
        pushButton_6->setObjectName("pushButton_6");
        pushButton_6->setGeometry(QRect(20, 170, 81, 31));
        pushButton_6->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
        pushButton_7 = new QPushButton(File);
        pushButton_7->setObjectName("pushButton_7");
        pushButton_7->setGeometry(QRect(20, 230, 81, 31));
        pushButton_7->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
        pushButton_8 = new QPushButton(File);
        pushButton_8->setObjectName("pushButton_8");
        pushButton_8->setGeometry(QRect(20, 300, 81, 31));
        pushButton_8->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
        pushButton_9 = new QPushButton(File);
        pushButton_9->setObjectName("pushButton_9");
        pushButton_9->setGeometry(QRect(20, 360, 81, 31));
        pushButton_9->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
        pushButton_10 = new QPushButton(File);
        pushButton_10->setObjectName("pushButton_10");
        pushButton_10->setGeometry(QRect(20, 420, 81, 31));
        pushButton_10->setStyleSheet(QString::fromUtf8("font: 11pt \"Comic Sans MS\";\n"
"color: rgb(0, 0, 0);\n"
"border: 2px solid black; \n"
"border-radius: 10px;"));
